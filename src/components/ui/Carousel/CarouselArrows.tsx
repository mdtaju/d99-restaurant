...
const CarouselPreviousBtn = (props: propsTypes) => {
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`absolute left-0 md:left-[-40px] top-[50%] translate-y-[-50%] p-[10px] border border-[#D9D9D9] rounded-[2px] z-10 bg-themeBlack`}>
      <svg
        width="12"
        height="13"
        viewBox="0 0 12 13"
        ...
        <path
          ...
          fill={`${className.includes("slick-disabled") ? "gray" : "white"}`}
        />
      </svg>
    </button>
  );
...
const CarouselNextBtn = (props: propsTypes) => {
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`absolute right-0 md:right-[-40px] top-[50%] translate-y-[-50%] p-[10px] border border-[#D9D9D9] rounded-[2px] z-10 bg-themeBlack`}>
      <svg
        width="12"
        height="13"
        viewBox="0 0 12 13"
